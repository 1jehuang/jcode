# ─────────────────────────────────────────────────────
# CarpAI - Production Environment
# ─────────────────────────────────────────────────────
# Implements multi-AZ high-availability infrastructure
# with production-grade scaling, backups, and monitoring.
...
module "carpai" {
  ...
  # EKS: larger node group for production load
  ...
  # RDS: multi-AZ with pgvector, 30-day backups, deletion protected
  ...
  # Redis: 3 shards with 2 replicas each, auto-failover
  ...
  # Monitoring: full production stack with ingress
