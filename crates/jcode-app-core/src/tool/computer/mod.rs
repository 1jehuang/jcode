...
impl Tool for ComputerTool {
    ...
    fn description(&self) -> &str {
        "Control this Mac, the user's live machine: only the requested task; prefer background \
         AX (press/set_value) over click/type. action='discover' lists all actions; 'setup' \
         fixes permissions."
    }
    ...
    fn parameters_schema(&self) -> Value {
        ...
        json!({
            ...
            "properties": {
                ...
                "action": {
                    "type": "string",
                    "description": "screenshot, ocr, ui, click, type, key, press, set_value, find_element, run_applescript, discover"
                },
                "category": {
                    "type": "string",
                ...
                "element": {
                    "type": "object",
                    "description": "Handle from find_element/ui, used by press/set_value/get_value/perform_action.",
                    "properties": {
                        "app": { "type": "string" },
