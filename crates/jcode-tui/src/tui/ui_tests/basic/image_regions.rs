...
fn test_prefix_reuse_mid_edit_reoffsets_region_below_boundary() {
    ...
    let k = super::prepare::matching_prefix_len(base.as_ref(), edited_state.display_messages.len(), |i| super::prepare::display_item_id(&edited_state, i));
...
fn test_prepend_shifts_suffix_image_regions_and_matches_full_build() {
    ...
    let s = super::prepare::matching_suffix_len(base.as_ref(), prepended_state.display_messages.len(), |i| super::prepare::display_item_id(&prepended_state, i));
