...
1. Download the appropriate release from [GitHub Releases](https://github.com/1jehuang/jcode/releases)
...
1. Check existing [GitHub Issues](https://github.com/1jehuang/jcode/issues) for similar problems
...
- [GitHub Issues](https://github.com/1jehuang/jcode/issues) - Bug reports and feature requests
