...
static DOMAIN_RULES: [DomainRule; 14] = [
    DomainRule { keywords: &["auth", "login", "logout", "session", "token", "password", "oauth",
        "认证", "登录", "授权", "鉴权"],
        domain_name: "Authentication", description: "用户认证与授权" },
    DomainRule { keywords: &["user", "profile", "account", "member", "customer",
        "用户", "会员", "账户"],
        domain_name: "User Management", description: "用户与账户管理" },
    DomainRule { keywords: &["payment", "billing", "invoice", "transaction", "order", "checkout",
        "支付", "账单", "订单", "结算"],
        domain_name: "Payment & Billing", description: "支付与计费" },
    DomainRule { keywords: &["notification", "email", "sms", "push", "alert", "message",
        "通知", "邮件", "短信", "推送"],
        domain_name: "Notification", description: "通知与消息" },
    DomainRule { keywords: &["search", "index", "query", "检索", "搜索", "索引"],
        domain_name: "Search", description: "搜索与索引" },
    DomainRule { keywords: &["report", "analytics", "dashboard", "statistic", "metric",
        "报表", "统计", "分析", "看板"],
        domain_name: "Analytics & Reports", description: "分析与报表" },
    DomainRule { keywords: &["admin", "management", "dashboard", "后台", "管理"],
        domain_name: "Admin", description: "后台管理" },
    DomainRule { keywords: &["file", "upload", "download", "storage", "image", "文档", "文件", "上传", "下载"],
        domain_name: "File Management", description: "文件与存储管理" },
    DomainRule { keywords: &["log", "logging", "audit", "monitor", "日志", "审计", "监控"],
        domain_name: "Logging & Audit", description: "日志与审计" },
    DomainRule { keywords: &["cache", "redis", "缓存"],
        domain_name: "Cache", description: "缓存管理" },
    DomainRule { keywords: &["api", "graphql", "rest", "grpc", "rpc", "endpoint", "接口"],
        domain_name: "API Gateway", description: "API网关与接口" },
    DomainRule { keywords: &["workflow", "pipeline", "job", "task", "schedule", "cron",
        "工作流", "流水线", "定时", "调度"],
        domain_name: "Workflow", description: "工作流与任务调度" },
    DomainRule { keywords: &["content", "article", "post", "blog", "page",
        "内容", "文章", "博客"],
        domain_name: "Content Management", description: "内容管理" },
    DomainRule { keywords: &["product", "inventory", "catalog", "product", "sku",
        "商品", "库存", "产品", "目录"],
