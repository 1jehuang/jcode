...
#[test]
fn await_candidates_default_to_owned_non_terminal_workers() {
    let members = vec![
        AgentInfo {
            session_id: "coord".to_string(),
            friendly_name: Some("coord".to_string()),
        ...
        AgentInfo {
            ...
            friendly_name: Some("ready".to_string()),
            files_touched: vec![],
            status: Some("ready".to_string()),
            detail: None,
            role: Some("agent".to_string()),
        ...
        AgentInfo {
            session_id: "old-other-running".to_string(),
        ...
        AgentInfo {
            session_id: "user-created-running".to_string(),
            friendly_name: Some("user".to_string()),
            files_touched: vec![],
            status: Some("running".to_string()),
            detail: None,
    ...
    assert_eq!(
        await_candidate_session_ids("coord", &members, &statuses),
        vec!["owned-running".to_string()]
    );
}
