...
fn c<'a>(cmd: &'a str, desc: &'a str, confirm: bool) -> (&'a str, &'a str, bool) {
    (cmd, desc, confirm)
}
...
mod tests {
    ...
    fn test_classify_intent_git_operation() {
        ...
        let intent = generator.classify_intent("undo last commit");
    ...
    fn test_classify_intent_docker() {
        let generator = make_generator();
        let intent = generator.classify_intent("stop all containers");
    ...
    fn test_classify_intent_network() {
        let generator = make_generator();
        let intent = generator.classify_intent("curl request to api");
    ...
    fn test_classify_intent_process() {
        let generator = make_generator();
        let intent = generator.classify_intent("kill process on port 3000");
    ...
    fn test_classify_intent_package() {
        let generator = make_generator();
        let intent = generator.classify_intent("install lodash npm");
    ...
    fn test_classify_intent_search() {
        let generator = make_generator();
        let intent = generator.classify_intent("find all occurrences of error");
    ...
    fn test_classify_intent_compression() {
        let generator = make_generator();
        let intent = generator.classify_intent("compress folder to zip");
    ...
    fn test_classify_intent_system_info() {
        let generator = make_generator();
        let intent = generator.classify_intent("show system uptime");
    ...
    fn test_classify_intent_text_processing() {
        let generator = make_generator();
        let intent = generator.classify_intent("count lines in main.rs");
    ...
    fn test_classify_intent_database() {
        let generator = make_generator();
        let intent = generator.classify_intent("query mysql database");
    ...
    fn test_classify_intent_file_operation() {
        let generator = make_generator();
        let intent = generator.classify_intent("delete old logs");
    ...
    fn test_classify_intent_other() {
        let generator = make_generator();
        let intent = generator.classify_intent("hello world");
    ...
    fn test_generate_git_status() {
        ...
        let results = generator.generate("git status", &ctx);
    ...
    fn test_generate_docker_stop_all() {
        ...
        let results = generator.generate("stop all containers", &ctx);
        assert(!results.is_empty());
    ...
    fn test_generate_curl_request() {
        ...
        let results = generator.generate("curl request to https://api.example.com", &ctx);
        assert(!results.is_empty());
    ...
    fn test_extract_entities_port() {
        let generator = make_generator();
        let entities = generator.extract_entities("kill process on port 8080");
    ...
    fn test_extract_entities_url() {
        let generator = make_generator();
        let entities = generator.extract_entities("download https://example.com/file.zip");
    ...
    fn test_extract_entities_quoted_name() {
        let generator = make_generator();
        let entities = generator.extract_entities(r#"find file named "config.toml""#);
    ...
    fn test_validate_safe_command() {
        ...
        let verdict = generator.validate_safety(&cmd);
    ...
    fn test_validate_destructive_blocked_conservative() {
        ...
        let generator = NlCommandGenerator::new(config);
        let cmd = GeneratedCommand {
    ...
    fn test_rank_by_history_prefers_frequent() {
        ...
        let ranked = generator.rank_by_history(cmds);
    ...
    fn test_render_command_with_entities() {
        ...
        let result = generator.render_command("kill $(lsof -t -i :{port})", &entities);
    ...
    fn test_estimate_impact_network_cmd() {
        let generator = make_generator();
        let impact = generator.estimate_impact("curl https://api.example.com");
    ...
    fn test_estimate_impact_build_cmd() {
        let generator = make_generator();
        let impact = generator.estimate_impact("cargo build --release");
    ...
    fn test_generate_npm_install() {
        ...
        let results = generator.generate("install lodash", &ctx);
        assert(!results.is_empty());
