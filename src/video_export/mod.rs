...
fn box_drawing_to_svg(
    ...
    let (left, right_seg, up, down, thick) = match ch {
        ...
        '█' => return Some(format!(r#"<rect x="{}" y="{}" width="{}" height="{}" fill="{}"/>"#, px, py, cw, ch_h, color)),
        '▀' => return Some(format!(r#"<rect x="{}" y="{}" width="{}" height="{}" fill="{}"/>"#, px, py, cw, ch_h / 2, color)),
        '▄' => return Some(format!(r#"<rect x="{}" y="{}" width="{}" height="{}" fill="{}"/>"#, px, py+ch_h/2, cw, ch_h/2, color)),
        '▌' => return Some(format!(r#"<rect x="{}" y="{}" width="{}" height="{}" fill="{}"/>"#, px, py, cw/2, ch_h, color)),
        '▐' => return Some(format!(r#"<rect x="{}" y="{}" width="{}" height="{}" fill="{}"/>"#, px+cw/2, py, cw/2, ch_h, color)),
        '░' | '▒' | '▓' => {
            let opacity = match ch { '░' => 0.25, '▒' => 0.50, '▓' => 0.75, _ => 0.5 };
